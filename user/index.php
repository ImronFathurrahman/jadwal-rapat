...
<div class="bg-light bg-opacity-50">
    <h4 style=" padding:20px 0px 0px 20px;">Selamat Datang <b><?php echo $_SESSION['nama']; ?>
        <h4 style=" padding:0px 0px 0px 20px;">
...
<div class="container" style="justify-content:center;display:flex;">
    <div class="row">
        <div class="col-md">
            <div class="card text-bg-primary mb-3" style="min-width: 15rem;">
                <div class="card-header"><a href="agenda2.php" class="btn btn-light">Lihat</a></div>
        ...
        <div class="col-md">
            <div class="card text-bg-danger mb-3" style="min-width: 15rem;">
                <div class="card-header"><a href="absensi2.php" class="btn btn-light">Lihat</a></div>
                <div class="card-body text-white">
        ...
        <div class="col-md">
            <div class="card text-bg-success mb-3" style="min-width: 15rem;">
                <div class="card-header"><a href="ruangan2.php" class="btn btn-light">Lihat</a></div>
                <div class="card-body text-white">
        ...
        <div class="col-md">
            <div class="card text-bg-secondary mb-3" style="min-width: 15rem;">
                <div class="card-header"><a href="peserta2.php" class="btn btn-light">Lihat</a></div>
                <div class="card-body text-white">
