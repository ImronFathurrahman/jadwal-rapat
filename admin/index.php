...
<div class="container" style="justify-content:center;display:flex;">
    <div class="row">
        <div class="col-md">
            <div class="card text-bg-primary mb-3" style="min-width: 12rem;">
                <div class="card-body text-white">
                    ...
                    <a href="agenda.php" class="btn btn-light">Lihat</a></div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-danger mb-3" style="min-width: 12rem;">
                ...
                <div class="card-body text-white">
                    ...
                    <a href="absensi.php" class="btn btn-light">Lihat</a>
                    
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-success mb-3" style="min-width: 12rem;">
                ...
                <div class="card-body text-white">
                    ...
                    <a href="ruangan.php" class="btn btn-light">Lihat</a>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-secondary mb-3" style="min-width: 12rem;">
                ...
                <div class="card-body text-white">
                    ...
                    <a href="peserta.php" class="btn btn-light">Lihat</a>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-info mb-3" style="min-width: 12rem;">
                ...
                <div class="card-body text-white">
                    ...
                    <a href="datauser.php" class="btn btn-light">Lihat</a>
                </div>
            </div>
        </div>
    </div>
