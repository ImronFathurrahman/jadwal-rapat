...
<head>
    ...
    <style> 
    .table-responsive { width: 65%; margin: 0 auto; border-collapse: collapse; } 
...
<body>
    ...
    <div class="table-responsive px-4">
        ...
        <table class="table table-bordered" width="20%">
            <tr class="table-light" style="align:center;">
                <th width="10%">No</th>
                <th wu>Peserta</th>
                <th>Aksi</th>
            </tr>
                ...
                <tr style="text-align:center;">
                    ...
                    <td>
                        <div style="display: flex; justify-content: center; row; gap: 8px;">
                            <a href="peserta_ubah.php?no=<?php echo $data['no']; ?>" class="btn btn-info" style="align-content: center; padding-left: 8px; padding-right: 8px;">Ubah <img src="../gambar/edit.png" alt="edit"></a>
                            <a href="peserta_hapus.php?no=<?php echo $data['no']; ?>" class="btn btn-danger" style="align-content: center; padding-left: 8px; padding-right: 8px;">Hapus <img src="../gambar/hapus.png" alt="hapus"></a>
                            <a href="peserta_detail.php?no=<?php echo $data['no']; ?>" class="btn btn-warning" style="align-content: center; padding-left: 8px; padding-right: 8px;">Detail <img src="../gambar/detail.png" alt="detail"></a>
                        </div>
                    </td>
