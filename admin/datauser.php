...
<head>
    ...
    <style> 
    .table-responsive { width: 90%; margin: 0 auto; border-collapse: collapse; } 
...
<body>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr class="bg-white" style="text-align:center;">
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $data['username']; ?></td>
                    <td width="10%"><?php echo $data['password']; ?></td>
                    ...
                    <td style="text-align:center;">
                        <div style="display: flex; justify-content: center; row; gap: 8px;">
                            <a href="datauser_ubah.php?id_user=<?php echo $data['id_user']; ?>" class="btn btn-info" style="align-content: center; padding-left: 8px; padding-right: 8px;">Ubah <img src="../gambar/edit.png" alt="edit"> </a></a><br>
                            <a href="datauser_hapus.php?id_user=<?php echo $data['id_user']; ?>" class="btn btn-danger" style="align-content: center; padding-left: 8px; padding-right: 8px;">Hapus <img src="../gambar/hapus.png" alt="print"> </a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
